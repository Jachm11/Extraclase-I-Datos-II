...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        grafo->setPixmap(QPixmap(QString::fromUtf8(":/graph2_copy.jpg")));
        dir = new QLabel(centralwidget);
        dir->setObjectName(QString::fromUtf8("dir"));
        dir->setGeometry(QRect(210, 430, 121, 41));
        QFont font;
        font.setPointSize(17);
        dir->setFont(font);
        dir->setStyleSheet(QString::fromUtf8("color: rgb(255, 255, 255);"));
        cos = new QLabel(centralwidget);
        cos->setObjectName(QString::fromUtf8("cos"));
        cos->setGeometry(QRect(590, 436, 101, 31));
        cos->setFont(font);
        cos->setStyleSheet(QString::fromUtf8("color: rgb(255, 255, 255);"));
        cam = new QLabel(centralwidget);
        cam->setObjectName(QString::fromUtf8("cam"));
        cam->setGeometry(QRect(950, 430, 101, 31));
        cam->setFont(font);
        ...
        buscar->setGeometry(QRect(560, 614, 121, 41));
        buscar->setStyleSheet(QString::fromUtf8("alternate-background-color: rgb(114, 159, 207);\n"
...
""));
        ...
        de->setStyleSheet(QString::fromUtf8("color: rgb(255, 255, 255);"));
        ...
        hacia->setStyleSheet(QString::fromUtf8("color: rgb(255, 255, 255);"));
        res = new QLabel(centralwidget);
        res->setObjectName(QString::fromUtf8("res"));
        res->setGeometry(QRect(210, 490, 891, 81));
        QFont font2;
        ...
        deNum->setFont(font3);
        deNum->setStyleSheet(QString::fromUtf8("color: rgb(255, 255, 255);"));
        aNum = new QLabel(centralwidget);
        aNum->setObjectName(QString::fromUtf8("aNum"));
        aNum->setGeometry(QRect(1050, 170, 61, 61));
        aNum->setFont(font3);
        aNum->setStyleSheet(QString::fromUtf8("color: rgb(255, 255, 255);"));
